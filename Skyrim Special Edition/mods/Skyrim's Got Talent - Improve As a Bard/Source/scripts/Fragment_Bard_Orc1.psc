...
Scriptname Fragment_Bard_Orc1 Extends TopicInfo Hidden

;BEGIN FRAGMENT Fragment_0
Function Fragment_0(ObjectReference akSpeakerRef)
Actor akSpeaker = akSpeakerRef as Actor
;BEGIN CODE
FluteGlobal.SetValue(FluteGlobal.GetValue() + 1)
LuteGlobal.SetValue(LuteGlobal.GetValue() + 1)
DrumGlobal.SetValue(DrumGlobal.GetValue() + 1)
...
Debug.Notification("You didn't learn much...")
	utility.wait(1.0)
;END CODE
EndFunction
;END FRAGMENT
