...
SetObjectiveDisplayed(75, false) ; SUR - changed to false
...
;END AUTOCAST
;BEGIN CODE
; SUR - changed the whole fragment
...
Game.GetPlayer().MoveTo(SkyrimUnboundMarkerCharGen)
SkyrimUnbound.SetStage(1)
;END CODE
EndFunction
;END FRAGMENT

;BEGIN FRAGMENT Fragment_338
Function Fragment_338()
;BEGIN AUTOCAST TYPE SkyrimUnboundMQ101Script
Quest __temp = self as Quest
SkyrimUnboundMQ101Script kmyQuest = __temp as SkyrimUnboundMQ101Script
;END AUTOCAST
;BEGIN CODE
; SUR - added fragment for new stage 1 (this stage is set from SkyrimUnboundQuestScript)
kmyQuest.FixHelgen()
;END CODE
EndFunction
;END FRAGMENT
...
SetObjectiveDisplayed(65, false) ; SUR - changed to false
...
;BEGIN CODE
;imperial objective
SetObjectiveDisplayed(60, false) ; SUR - changed to false
...
;IntoTorriScene.start() ; SUR - disabled
;END CODE
EndFunction
;END FRAGMENT
...
SetObjectiveDisplayed(70, false) ; SUR - changed to false
;END CODE
EndFunction
;END FRAGMENT
...
; SUR - added properties
Quest Property SkyrimUnbound  Auto  

ObjectReference Property SkyrimUnboundMarkerCharGen Auto

Bool Property SkyrimUnboundScriptWins = True Auto Hidden
