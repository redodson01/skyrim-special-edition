...
; SUR - added
GlobalVariable MQ102IntegrityReport = Game.GetFormFromFile(0x855725, "Skyrim Unbound.esp") as GlobalVariable
if SkyrimUnboundOverrideWins
	MQ102IntegrityReport.SetValue(2)
else
	MQ102IntegrityReport.SetValue(1)
endif
;END CODE
EndFunction
;END FRAGMENT
...
if GetStage() < 100
	...
	;WhiterunMapMarker.AddToMap() ; SUR - disabled
else
...
MQ101.SetStage(900)
SetObjectiveDisplayed(10, false) ; SUR - changed to false
;RiverwoodMapMarker.AddToMap() ; SUR - disabled
