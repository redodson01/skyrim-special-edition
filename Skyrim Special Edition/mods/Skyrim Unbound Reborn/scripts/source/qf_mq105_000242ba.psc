...
if (!Game.IsWordUnlocked(WordFus))
	...
	if UnlockShouts.GetValueInt() != 1 && PlayerRef.GetActorValue("DragonSouls") > 0 
		PlayerRef.ModActorValue("DragonSouls", -1)
	endif
	Game.UnlockWord(WordFus)
	WordLearned.SetValueInt(1)
endif
Utility.Wait(35.0)
MQ105GreybeardCallKeyword.SendStoryEvent()
...
; SUR - added
GlobalDragonsEnabled.SetValueInt(1)
...
;setstage(5) ; SUR - disabled
;setstage(10) ; SUR - disabled

;SUR - added
GlobalVariable MQ105IntegrityReport = Game.GetFormFromFile(0x855728, "Skyrim Unbound.esp") as GlobalVariable
if WordLearned
	MQ105IntegrityReport.SetValue(2)
else
	MQ105IntegrityReport.SetValue(1)
endif
;END CODE
EndFunction
;END FRAGMENT
...
Keyword Property MQ105GreybeardCallKeyword  Auto  

ObjectReference Property DelphineIntroStart  Auto  

ObjectReference Property SleepingGiantIntroTrigger  Auto  

GlobalVariable Property GlobalDragonsEnabled  Auto  

WordOfPower Property WordFus  Auto 

GlobalVariable Property UnlockShouts  Auto 

GlobalVariable Property WordLearned  Auto
