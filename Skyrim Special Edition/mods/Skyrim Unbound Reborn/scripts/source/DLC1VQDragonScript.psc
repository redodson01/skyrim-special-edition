...
function TeachWordToPlayer()
	...
	if iSummonCount >= 1 && GetStageDone(40) == false
		...
		SetStage(40)
		if !DragonSoulsEnabled.GetValue() || (UnlockShouts.GetValue() && UnlockShouts.GetValueInt() != 2)
			Game.UnlockWord(SoulTearingWords[0])
		endif
	endif
	...
	if iSummonCount >=2 && GetStageDone(50) == false
		...
		SetStage(50)
		if !DragonSoulsEnabled.GetValue() || (UnlockShouts.GetValue() && UnlockShouts.GetValueInt() != 3)
			Game.UnlockWord(SoulTearingWords[1])
		endif
	endif
	...
	if iSummonCount >= 3 && GetStageDone(60) == false
		...
		SetStage(60)
		if !DragonSoulsEnabled.GetValue() || (UnlockShouts.GetValue() && UnlockShouts.GetValueInt() != 3)
			Game.UnlockWord(SoulTearingWords[2])
		endif
	endif
