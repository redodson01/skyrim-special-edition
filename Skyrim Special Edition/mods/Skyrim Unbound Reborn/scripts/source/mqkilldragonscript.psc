...
; 	; 	;	debug.trace(self + " setting MQ104 stage 90")
	...
	GlobalVariable SoulAbsorbed = Game.GetFormFromFile(0x0022F0, "Skyrim Unbound.esp") as GlobalVariable
	SoulAbsorbed.SetValueInt(1)

	Quest MQ105 = Game.GetFormFromFile(0x0242BA, "Skyrim.esm") as Quest
	if !MQ105.GetStageDone(10)
		MQ105.SetStage(5)
		(Game.GetFormFromFile(0xD62, "Skyrim Unbound.esp") as SkyrimUnboundQuestScript).CheckIntegrityAfterMainQuestStart()
	endif
...
Bool Property SkyrimUnboundScriptWins = True Auto
