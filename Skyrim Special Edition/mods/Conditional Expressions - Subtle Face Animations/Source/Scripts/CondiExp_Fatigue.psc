...
breathlimit = breathlimit + 1

;;;;;;;;;;; SOUNDS ;;;;;;;;;;;;
If Condiexp_Sounds.GetValue() > 0 && PlayerRef.IsSwimming() == false
...
If PlayerRef.GetActorValuePercentage("Stamina") < 0.5 && PlayerRef.GetActorValuePercentage("Health") > 0.5 && breathlimit < 21 
Breathe()
else
Exhale(33,0)
Utility.Wait(1)

;exiting or waiting for enough stamina to recover
